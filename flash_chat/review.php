...
require ("chat/required/config$lg.php");
?>
<html>
<head>
...
$chat_file_ok = "chat/required/msg.txt";//message file

$users_file = "chat/required/users.txt";//The file where you save users and passwords
