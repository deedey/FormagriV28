...
$url="http://www.mmedia.educagri.fr/foad/flash_chat/"; //absolute url to scripts directory
...
$enter_string = "(Vient d'entrer dans le salon)";//message showed when a new user enters.

$bye_user = "(Vient de quitter le salon)";//message showed when a user exits.
...
$intro_text .=" Vous pouvez voir les autres utilisateurs connectés et envoyer un message à l'un d'entre eux en particulier (' icône: personnage'), activer ou  désactiver les son ('icône: parleur') and revoir la conversation conversation ('icône: retour).\n";
