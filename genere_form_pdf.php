    ...
    else
    {
       if ($utilisateur > 0)
       {
         ...
         $bgcolorC = '#e1eaef';
           ...
           $fichier_pdf .=  "<TD align='left' width='5%' bgcolor='$bgcolor2'><FONT COLOR=#FFFFFF><b>Nombre d'accès</b></FONT></TD>";
           $fichier_pdf .=  "<TD align='left' width='5%' bgcolor='$bgcolor2'><FONT COLOR=#FFFFFF><b>Temps consacré</b></FONT></TD>";
           $fichier_pdf .=  "<TD align='left' width='5%' bgcolor='$bgcolor2'><FONT COLOR=#FFFFFF><b>Dates d'accès</b></FONT></TD>";
           $fichier_pdf .=  "</TR>";
       if ($scormOk == 0)
       {
          $ii = 0;
