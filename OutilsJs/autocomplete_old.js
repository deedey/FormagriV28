...
//        if (!($.browser.msie) && is_win2k) {
//            results.style.marginTop='-36px';
//            results.style.marginLeft='-11px';
//        }
        ...
        if (!($.browser.msie) && is_win2k)
        {
           $results.hide().addClass(options.resultsClass).css({
                position: "absolute",
               // top: (pos.y - (options.pp*25) +input.offsetHeight) + "px",
               // left: (pos.x -11) + "px"
                top: (pos.y + input.offsetHeight) + "px",
                left: pos.x + "px"
           });
//alert (pos.y +"-"+input.offsetHeight +"ou "+options.pp*25);
        }else
        {
           $results.hide().addClass(options.resultsClass).css({
                position: "absolute",
...
//alert (pos.y +" 2 - "+input.offsetHeight);
         }
        // Add to body element
        $("body").append(results);
