...
class Zend_Json_Encoder
{
	 ...
	 * @return void
	 */
	function Zend_Json_Encoder($cycleCheck = false)
	{
	 ...
	 */
	function encode($value, $cycleCheck = false)
	{
	...
	/**
	 * Encode an object to JSON by encoding each of the var properties
	 *
	...
	/**
	 * Encode the var methods of the ReflectionClass in the
	 * class2 format
	 *
	 * @param $cls ReflectionClass
	 ...
	 */
	function encodeClass($className, $package = '')
	{
	 ...
	 * @return string
	 */
	function encodeClasses($classNames, $package = '')
	{
		$result = '';
