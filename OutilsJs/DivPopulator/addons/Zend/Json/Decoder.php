...
class Zend_Json_Decoder
{
	 ...
	 * for var consumption, they are just used internally to the
	 * class.
	 */
	const EOF = 0;
	const DATUM = 1;
	 ...
	 * @return void
	 */
	function Zend_Json_Decoder($source, $decodeType)
	{
		// Set defaults
		$this->_source = $source;
	 ...
	 */
	function decode($source = null, $objectDecodeType = Zend_Json :: TYPE_ARRAY)
	{
		if (null === $source)
		{
