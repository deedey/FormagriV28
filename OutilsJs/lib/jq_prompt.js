...
jQuery.extend({
        prompt: function(m,o){
                o = jQuery.extend({ prefix:'jqi', buttons:{ Ok:true }, submit:function(){return true;}, callback:function(){}, container:'body', opacity:0.6, overlayspeed:'slow', promptspeed:'fast', show:'show'},o);
