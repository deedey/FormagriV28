 ...
 */
/**
 *la commande est browser, version, OS:
 *   $('#test-browser').html( 'Votre navigateur est : ' + $.browser.browser() );
 *   $('#test-version').html( 'Sa version est : ' + $.browser.version.string() + ' (' + $.browser.version.number() + ')' );
 *   $('#test-os').html( 'Votre système d\'exploitation est :: ' + $.browser.OS() );
 *    var afficher_version = ( 'Navigateur : ' + $.browser.browser() + '\nVersion : '  +$.browser.version.string() + ' (' + $.browser.version.number() + ')' +
 *    '\nSystème d\'exploitation : ' + $.browser.OS());
 *    //document.write(afficher_version);
</script>**/
new function() {
    /**
