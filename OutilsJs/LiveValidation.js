...
LiveValidation.prototype.initialize = function(element, optionsObj){
        ...
        this.validMessage = options.validMessage || '__';//Merci!
...
LiveValidation.prototype.getElementType = function(){
        switch(true){
                  ...
                  default:
                          throw new Error('LiveValidation::getElementType - Cet élement doit etre un input ou un textarea!');
        }
}
...
Validate.Presence = function(value, paramsObj){
        ...
        var message = paramsObj.failureMessage || "__";
...
Validate.Numericality = function(value, paramsObj){
    ...
    var notANumberMessage = paramsObj.notANumberMessage || "Format numérique";
    var notAnIntegerMessage = paramsObj.notAnIntegerMessage || " Doit être un entier!";
        var wrongNumberMessage = paramsObj.wrongNumberMessage || " Doit être " + is + "!";
        var tooLowMessage = paramsObj.tooLowMessage || " Doit être plus grand que " + minimum + "!";
        var tooHighMessage = paramsObj.tooHighMessage || " Doit être plus grand que " + maximum + "!";
    ...
    if (paramsObj.onlyInteger && (/\.0+$|\.$/.test(String(suppliedValue))  || value != parseInt(value)) ) Validate.fail(notAnIntegerMessage);
        switch(true){
                  ...
                  case (minimum !== null && maximum !== null):
                          Validate.Numericality(value, {failureMessage: tooLowMessage, minimum: minimum});
                          Validate.Numericality(value, {failureMessage: tooHighMessage, maximum: maximum});
                          break;
                  case (minimum !== null):
    ...
    var wrongLengthMessage = paramsObj.wrongLengthMessage || "Must be " + is + " characters long!";
        ...
        switch(true){
                  case (is !== null):
                        ...
                        break;
                  case (minimum !== null && maximum !== null):
                          Validate.Length(value, {failureMessage: tooShortMessage, minimum: minimum});
                          Validate.Length(value, {failureMessage: tooLongMessage, maximum: maximum});
                          break;
                  case (minimum !== null):
