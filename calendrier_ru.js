...
Calendar.Months = ["ﬂÌ‚‡¸", "‘Â‚‡Î¸", "MaÚ", "AÔÂÎ¸", "MaÈ", "»˛Ì¸",
        "»˛Î¸", "A‚„ÛÒÚ", "—ÂÌÚˇ·¸", "OÍÚˇ·¸", "ÕÓˇ·¸", "ƒÂÍ‡·¸"];
// Short Month names in YOUR Language
Calendar.SMonths = ["ﬂÌ‚", "‘Â‚", "MaÚ", "AÔ", "MaÈ", "»˛Ì¸", "»˛Î¸", "A‚„",
        "—ÂÌ", "ŒÍÚ", "ÕÓˇ", "ƒÂÍ"];
// Month names in English
Calendar.EMonths = ["ﬂÌ‚‡¸", "‘Â‚‡Î¸", "MaÚ", "AÔÂÎ¸", "MaÈ", "»˛Ì¸",
        "»˛Î¸", "A‚„ÛÒÚ", "—ÂÌÚˇ·¸", "OÍÚˇ·¸", "ÕÓˇ·¸", "ƒÂÍ‡·¸"];
...
Calendar.DOW = ["¬ÓÒÍÂÒÂÌ¸Â", "œÓÌÂ‰ÂÎ¸ÌËÍ", "¬ÚÓÌËÍ", "—Â‰‡", "◊ÂÚ‚Â„", "œˇÚÌËˆ‡", "—Û··ÓÚ‡"];
Calendar.count = 0;

// For inline calendar, the default contents of the layer. (v1.3)
Calendar.gInitText = " ‡ÎÂÌ‰‡¸";
...
Calendar.prototype.showSmartNavBar = function() {
        ...
        selcalendar += "</td><td bgcolor=#CEE6EC>" +

                "<A HREF=\"javascript:void(0);\" onClick=\"document.frmCal.cy.value++;document.frmCal.cy.onchange();return false;\"" +
                " onmouseover=\"img_flhp.src='images/agenda/ptiflechob.gif';return true;\"" +
                " onmouseout=\"img_flhp.src='images/agenda/ptiflecho.gif'\">" +
                "<IMG NAME=\"img_flhp\" SRC=\"images/agenda/ptiflecho.gif\" BORDER='0' valign='top'" +
                " onLoad=\"tempImg=new Image(0,0); tempImg.src='images/agenda/ptiflechob.gif'\">" +
                "</A>" +

                "</td></tr><tr width=100%><td bgcolor=#CEE6EC>" +

                "<A HREF=\"javascript:void(0);\" onClick=\"document.frmCal.cy.value--;document.frmCal.cy.onchange();return false;\" " +
                " onmouseover=\"img_flbp.src='images/agenda/ptiflechbasb.gif';return true;\"" +
                " onmouseout=\"img_flbp.src='images/agenda/ptiflechbas.gif'\">" +
                "<IMG NAME=\"img_flbp\" SRC=\"images/agenda/ptiflechbas.gif\" BORDER='0' valign='top'" +
                " onLoad=\"tempImg=new Image(0,0); tempImg.src='images/agenda/ptiflechbasb.gif'\">" +
                "</A>" +
       ...
       // this.wwriteA("<TD BGCOLOR='#CEE6EC' ALIGN=RIGHT valign=bottom>" +

                //"<FONT FACE='" + fontface + "' SIZE=1><B>" +

                //"Fixer" +

                //"<INPUT TYPE=CHECKBOX NAME=fixCheck title=\"Activez ou dÈsactivez pour rendre cette fenÍtre fixe ou mobile\"" +

                //((v_Fix == "Yes") ? "CHECKED " : "") +

                //"onClick=\"" +

               // ((this.gType == "POPUP") ? "alert('Fixe la fenÍtre')" : "fixCal(this.checked);") +
...
Calendar.prototype.show = function() {
        ...
        this.wwrite("<head><title> ‡ÎÂÌ‰‡¸</title>");
        ...
        if (v_Nav == "Yes") {
                ...
                this.wwrite("<FONT COLOR=black FACE='" + fontface + "' SIZE=1>" +
                                ...
                                "<IMG NAME=\"img_flg\" SRC=\"images/agenda/ptiflechg.gif\" BORDER='0' valign='top'" +
                ...
                this.wwrite("<FONT COLOR=black FACE='" + fontface + "' SIZE=1>" +
                                ...
                                "<IMG NAME=\"img_flgp\" SRC=\"images/agenda/ptiflech2g.gif\" BORDER='0' valign='top'" +
                ...
                this.wwrite("<FONT COLOR=black FACE='" + fontface + "' SIZE=1>" +
                                ...
                                ");\">—Â„Ó‰Ìˇ<\/A></FONT></DIV></TD><TD ALIGN=center>");
                ...
                this.wwrite("<FONT COLOR=black FACE='" + fontface + "' SIZE=1>" +
                                ...
                                "<IMG NAME=\"img_fldp\" SRC=\"images/agenda/ptiflech2d.gif\" BORDER='0' valign='top'" +
                ...
                this.wwrite("<FONT COLOR=black FACE='" + fontface + "' SIZE=1>" +
                                ...
                                "<IMG NAME=\"img_fld\" SRC=\"images/agenda/ptiflechd.gif\" BORDER='0' valign='top'" +
...
Calendar.prototype.showY = function() {
        ...
        this.wwrite("<DIV id='sequence'>[<A HREF=\"" +
                        ...
                        "\" title='AnnÈe prÈcÈdente'><<<\/A>]</DIV></TD><TD ALIGN=center>");
...
//                window.status = "DÈplacement du calendrier dans la fenÍtre --> nouvelles coordonnÈes X=" + (currX-cx) + ", Y=" + (currY-cy);
...
//        gCal.gTitle = v_Title ? v_Title : gCal.gMonthName + "/" + gCal.gYear;
        gCal.gTitle = v_Title ? v_Title : " ‡ÎÂÌ‰‡¸";
