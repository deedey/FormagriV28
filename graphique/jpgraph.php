...
//===================================================
class DateLocale {
    var $iLocale=LANGUE;         // Default to english
    var $iDayAbb = array(
        array("L","M","M","J","V","S","D"),                                // Français locale
        array("M","T","W","T","F","S","S"),                                // English locale
        array("Ï","Â","Ñ","×","Ï","Ñ","Â"));                        // Russian locale
    var $iShortDay = array(
        array("Lun","Mar","Mer","Jeu","Ven","Sam","Dim"),
        array("Mon","Tue","Wed","Thu","Fri","Sat","Sun"),
        array("Ïí","Âò","Ñð","×ò","Ïò","Ñá","Âñ"));
    var $iShortMonth = array(
        array("Jan","Fev","Mar","Avr","Mai","Jui","Jul","Aou","Sep","Oct","Nov","Dec"),
        array("Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"),
        array("ßíâ","Ôåâ","Ìàð","Àïð","Ìàé","Èþíü","Èþë","Àâã","Ñåí","Îêò","Íîÿ","Äåê"));
    var $iMonthName = array(
        array("Janvier","Février","Mars","Avril","Mai","Juin","Juillet","Août","Septembre","Octobre","Novembre","Décembre"),
        array("January","Febriary","March","April","May","June","Julliet","August","September","October","November","December"),
        array("ßíâàðü","Ôåâðàëü","Ìàðò","Àïðåëü","Ìàé","Èþíü","Èþëü","Àâãóñò","Ñåíòÿáðü","Îêòÿáðü","Íîÿáðü","Äåêàáðü"));
...
//Dey Overlib;
    ...
    function GetHTMLImageMap($aMapName) {
        $im = "<div id='overDiv' style='position:absolute; visibility:hidden;z-index:1000;'></div>\n
              <SCRIPT LANGUAGE='JavaScript' SRC='../overlib.js'></SCRIPT>\n".
              "<map name=\"$aMapName\" id=\"$aMapName\" >\n";
