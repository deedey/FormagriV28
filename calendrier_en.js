...
Calendar.Months = ["January", "February", "March", "April", "May", "June",
        "Julliet", "August", "September", "October", "November", "December"];
// Short Month names in YOUR Language
Calendar.SMonths = ["Jan", "Feb", "Mar", "Apr", "May", "June", "Jul", "Aug",
        "Sep", "Oct", "Nov", "Dec"];
        ...
        for (i=0; i<mach.length; i++) {
                ...
                switch (mach[i].toUpperCase()) {
                        ...
                        case "DOW":
                                ...
                                re += "(MONDAY|THUSDAY|WEDNESDAY|THURSDAY|FRIDAY|SATURDAY|SUNDAY)";
                        ...
                        case "MON":
                                ...
                                re += "(JAN|FEB|MAR|APR|MAY|JUNE|JUL|AUG|SEPT|OCT|NOV|DEC)";

                                whoarr.push(mach[i]); break;

                        case "MONTH":

                                re += "(JANUARY|FEBRUARY|MARCH|APRIL|MAY|JUNE|JULLIET|AUGUST|SEPTEMBER|OCTOBER|NOVEMBER|DECEMBER)";
...
Calendar.prototype.show = function() {
        ...
        if (v_Nav == "Yes") {
                ...
                this.wwrite("<FONT COLOR=black FACE='" + fontface + "' SIZE=1>" +
                                ...
                                ");\">Today<\/A></FONT></DIV></TD><TD ALIGN=center>");
...
//        gCal.gTitle = v_Title ? v_Title : gCal.gMonthName + "/" + gCal.gYear;
        gCal.gTitle = v_Title ? v_Title : "Calendar";
