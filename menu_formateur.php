...
if (isset($lemode_user) && ($lemode_user == 'tout' || $lemode_user == 'rien'))
{
   unset($_SESSION['mode_user']);
...
$lien_rf = urlencode($lien_rf);
   ...
   $requete_parc = mysql_query("select parcours_cdn from parcours where parcours_auteur_no = $id_user");
   $nb_requete_parc = mysql_num_rows($requete_parc);
...
<A HREF="<?php  echo "trace.php?link=$lien_accueil1";?>" target='main' class="bouton1" onClick="javascript:document.location.replace('<?php  echo $lien_accueil ;?>');">&nbsp;&nbsp;<?php  echo $mess_acc ;?>&nbsp;&nbsp;</A>
