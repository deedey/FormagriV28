...
entete_simple($mess_gp_seq_parc." ".strtolower($mess_gp_hsd));
...
echo "<tr><td colspan='3'class='sous_titre'><strong>$mess_gp_nom_grp</strong> : $nom_grp<br />$mess_gp_seq_parc ".
     strtolower($mess_gp_hsd)."</td></tr>";
echo "<tr>";
