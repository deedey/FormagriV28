<script type="text/javascript">
       // basé sur l'API de Claroline (Université Catholique de Louvain) avec l'ajout des interactions et Objectives
        var init_total_time = "<?php echo $sco['total_time']; ?>";
        var id_util = "<?php echo $_SESSION['id_user']; ?>";
        var scormid = "<?php echo $scormid; ?>";
        var numero_groupe = "<?php echo $numero_groupe; ?>";
        // ====================================================
...
//                            alert('element = '+ val +"  "+ ele +"cmi.objectives._count = " +count_objectives);
        ...
        elements[0]  = "cmi.core._children";values[0]  = "<?php echo $sco['_children']; ?>";
        elements[1]  = "cmi.core.student_id";values[1]  = "<?php echo $sco['student_id']; ?>";
        elements[2]  = "cmi.core.student_name";values[2]  = "<?php echo $sco['student_name']; ?>";
        elements[3]  = "cmi.core.lesson_location";values[3]  = "<?php echo $sco['lesson_location']; ?>";
        elements[4]  = "cmi.core.lesson_status";values[4]  = "<?php echo $sco['lesson_status'];?>";
        elements[5]  = "cmi.core.credit";values[5]  = "<?php echo $sco['credit']; ?>";
        elements[6]  = "cmi.core.entry";values[6]  = "<?php echo $sco['entry'];?>";
        elements[7]  = "cmi.core.score._children";values[7]  = "<?php echo $sco['score_children']; ?>";
        elements[8]  = "cmi.core.score.raw";values[8]  = "<?php echo $sco['raw'];?>";
        elements[9]  = "cmi.core.total_time";values[9]  = "<?php echo $sco['total_time'] ?>";
        elements[10] = "cmi.core.exit";values[10] = "<?php echo $sco['exit']; ?>";
        elements[11] = "cmi.core.session_time";values[11] = "<?php echo $sco['session_time']; ?>";
        elements[12] = "cmi.suspend_data";values[12] = "<?php echo $sco['suspend_data'];?>";
        elements[13] = "cmi.launch_data";values[13] = "<?php echo $sco['launch_data'];?>";
        elements[14] = "cmi.core.score.min";values[14] = "<?php echo $sco['scoreMin'];?>";
        elements[15] = "cmi.core.score.max";values[15] = "<?php echo $sco['scoreMax'];?>";
        elements[16] = "cmi.completion_status";values[16] = "<?php echo $sco['lesson_status']?>";//2004
        elements[17] = "cmi.success_status";values[17] = "<?php echo $sco['lesson_status']?>";//2004
        elements[18] = "cmi.core.lesson_mode";values[18] = "<?php echo $sco['lesson_mode'];?>";
        elements[19] = "cmi.interactions._count";values[19] = "";
        elements[20] = "cmi.score.scaled";values[20] = "<?php echo $sco['score_scaled'];?>";//2004
        elements[21] = "cmi.exit";values[21] = "<?php echo $sco['exit2'];?>";
        elements[22] = "cmi.objectives._children";values[22]  = "<?php echo $sco['objectives_children']; ?>";
        elements[23] = "cmi.objectives._count";values[23] = "";
        elements[24] = "cmi.comments";values[24] = "<?php echo $sco['comments'];?>";
        elements[25] = "cmi.comments_from_lms";values[25] = "<?php echo $sco['comments_from_lms'];?>";
        elements[26] = "cmi.interactions._children";values[26] = "<?php echo $sco['interactions_children'];?>";
        // ====================================================
        //
        //
        function do_commit(){
        //chaine inter = unescape(chaine_inter);
        //if (pointeur == 1)
        //alert (pointeur + "---> "+chaine_inter);
            chaine_data="id_util=<?php echo $id_user; ?>|numero_groupe=<?php echo $numero_groupe; ?>|scormid=<?php echo $scormid; ?>|id_seq=<?php echo $id_seq; ?>|lesson_location="+values[3]+"|lesson_status="+values[4]+"|credit="+values[5]+"|entry="+values[6]+"|raw="+values[8]+"|total_time="+values[9]+"|session_time="+values[11]+"|suspend_data="+values[12]+"|scoreMin="+values[14]+ "|scoreMax="+values[15]+"|comments_from_lms="+values[25]+"|lesson_mode="+values[18]+"#inter_nb="+pointeur+"#chaine_inter="+chaine_inter;
            //alert ("chaine_data est  :\n" + chaine_data);
            //alert ("suspend_data est  :\n" + values[11]);
              //Le formulaire cible se trouve dans la Frame cachée idsFrame
              cmiForm = idsFrame.document.forms[0];
              //Validation des nouvelles entrées en direction de l'updater
              cmiForm.id_util.value = "<?php echo $id_user; ?>";
              cmiForm.scormid.value = "<?php echo $scormid; ?>";
              cmiForm.id_seq.value = "<?php echo $id_seq; ?>";
              cmiForm.numero_groupe.value = "<?php echo $numero_groupe; ?>";
               //Données à intégrer dans la table scorm_util_module
              ...
              cmiForm.comments.value = values[24];
              cmiForm.comments_from_lms.value = values[25];
              cmiForm.scoreMin.value = values[14];
              cmiForm.scoreMax.value = values[15];
              cmiForm.lesson_mode.value = values[18];
              cmiForm.chaine_inter.value = unescape(chaine_inter);
              cmiForm.inter_nb.value = pointeur;
              cmiForm.chaine_objectives.value = chaine_objectif;
              cmiForm.objectives_nb.value = pointeur2;
              cmiForm.submit();
