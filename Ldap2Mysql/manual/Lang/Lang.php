        ...
        function getParam($lang)
        {
                ...
                switch ($lang)
                {
                        ...
                        case 'fr_FR' :
                                ...
                                $aParamLang['Ldap2Mysql']['base']['lien_3'] = 'Executer une importation';
                                $aParamLang['Ldap2Mysql']['base']['lien_4'] = 'Authentification externe';
                                $aParamLang['Ldap2Mysql']['base']['lien_5'] = 'Consulter';
                                //                                $aParamLang['Ldap2Mysql']['base']['lien_6'] = 'Synchronizer';
                                //
                                //configuration base
                ...
                $aParamLang['Ldap2Mysql']['config_import']['writeFileMessageSucceed'] = 'Configuration sauvegard&eacute;e';
                                ...
                                $aParamLang['Ldap2Mysql']['ldap_import']['libelle_28'] = 'Affichage des utilisateurs inscrits dans la base Mysql mais ne poss&egrave;dant pas de lien avec l\'annuaire <b>ldap</b> &agrave; jour';
