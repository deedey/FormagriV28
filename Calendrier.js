...
Calendar.prototype.showSmartNavBar = function() {
        var selcalendar = "<table width=100% border=0 bgcolor=#e1eaef><tr><td rowspan=2 bgcolor=#e1eaef>";
        ...
        selcalendar +=        "<\/select>\n</td><td rowspan=2 bgcolor=#e1eaef>";
        ...
        selcalendar += "</td><td bgcolor=#e1eaef>" +
                "<A HREF=\"javascript:void(0);\" onClick=\"document.frmCal.cy.value++;document.frmCal.cy.onchange();return false;\">" +
                "<FONT FACE=Arial SIZE=1 color=blue>^</FONT></A>" +
                "</td></tr><tr width=100%><td bgcolor=#e1eaef>" +
                "<A HREF=\"javascript:void(0);\" onClick=\"document.frmCal.cy.value--;document.frmCal.cy.onchange();return false;\">" +
                "<FONT FACE=Arial SIZE=1 color=blue>v</FONT></A>" +
                "</td>";
        this.wwrite(selcalendar);
        // Code to let users fix the calendar or let it move
        this.wwriteA("<TD BGCOLOR='#e1eaef' ALIGN=RIGHT valign=bottom>" +
                "<FONT FACE='" + fontface + "' SIZE=1><B>" +
                "Fixer" +
                "<INPUT TYPE=CHECKBOX NAME=fixCheck title=\"Activez ou désactivez pour rendre cette fenêtre fixe ou mobile\"" +
                ((v_Fix == "Yes") ? "CHECKED " : "") +
                "onClick=\"" +
                ((this.gType == "POPUP") ? "alert('Fixe la fenêtre')" : "fixCal(this.checked);") +
                "\"></B></FONT>" +
                "</TD></TR><TR>");
}
...
Calendar.prototype.show = function() {
        ...
        this.wwrite("<TABLE cellSpacing=0 cellPadding=0 align=center border=0><TBODY><TR><TD><IMG src=\"images/croix/coinhaut-gauche.png\"></TD><TD bgColor=\"#5b8bab\" align=right><IMG src=\"images/vide1.gif\" width=1 height=1></TD><TD><A HREF='javascript:" +
                this.WHO + "Calendar.Close(\"" + this.gType + "\", \"" + this.INLINE + "\");'><IMG src=\"images/croix/croix.png\" border=0></A></TD></TR><TR bgColor=#5b8bab><TD align=middle width=10><IMG src=\"images/vide.gif\" width=1 height=1></TD><TD>" +
         "<CENTER><FONT COLOR=white SIZE=3 FACE='" + fontface + "' SIZE=2><B>" + this.gTitle + "</B></FONT><P><TABLE WIDTH='" + (v_Width-30) + "'BORDER=1 CELLPADDING=0 BGCOLOR='#e1eaef'><TR><TD>" +
                "<TABLE BORDER=0 WIDTH='100%' CELLPADDING=0 BGCOLOR='#e1eaef'>" +
                "<TR><TD BGCOLOR='#5b8bab' ALIGN=MIDDLE>" +
        ...
        if (v_Nav == "Yes") {
                this.wwrite("<TABLE WIDTH='" + (v_Width-30) + "' BORDER=0 CELLSPACING=0 CELLPADDING=0 BGCOLOR='#e1eaef'><TR><TD ALIGN=center>");
                ...
                this.wwrite("<FONT COLOR=black FACE='" + fontface + "' SIZE=1>" +
                                ...
                                ");\">Aujourd\'hui<\/A>]</FONT></TD><TD ALIGN=center>");
                this.wwrite("<FONT COLOR=black FACE='" + fontface + "' SIZE=1>" +
                                "[<A HREF=\"" +
                                "javascript:" + this.WHO + "Build(" +
        ...
        this.wwrite("</TD></TR></TABLE></TD></TR></TBODY></TABLE><FONT face=\"Verdana, Arial, Helvetica, sans-serif\" size=1><B></B></FONT></TD><TD align=middle><IMG height=1 src=\"images/vide.gif\" width=1></TD></TR><TR><TD bgColor=#5b8bab><IMG src=\"images/vide.gif\" width=1 height=1></TD><TD bgColor=#5b8bab><IMG height=1 src=\"images/vide.gif\" width=1></TD><TD><IMG  src=\"images/croix/coinbas-droit.png\"></TD></TR></TBODY></TABLE>");
...
Calendar.prototype.showY = function() {
        ...
        this.wwrite("[<A HREF=\"" +
                        ...
                        ");" +
                        "\" alt='Année prédédente'><<<\/A>]</TD><TD ALIGN=center>");
        this.wwrite("[<A HREF=\"" +
                        "javascript:window.opener.Build(" +
